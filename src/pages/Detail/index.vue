          ...
          <div class="choose">
            <div class="chooseArea">
              ...
              <dl v-for="(attr) in spuSaleAttrList" :key="attr.id">
                ...
                <dd changepirce="0" :class="{active:attr2.isChecked==1}" 
                     v-for="attr2 in attr.spuSaleAttrValueList"  :key="attr2.id"
                     @click="changeChecked(attr2,attr.spuSaleAttrValueList)"
                     >{{attr2.saleAttrValueName}}</dd>
              </dl>
  ...
  export default {
    ...
    methods:{
      ...
      changeNum(){
        ...
        if(this.num<1||isNaN(this.num)){
          this.num=1
        }
      },
      changeChecked(attr2,spuSaleAttrList){
          // console.log(attr2,spuSaleAttrList)
